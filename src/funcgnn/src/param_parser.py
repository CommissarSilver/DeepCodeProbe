...
def parameter_parser():
    ...
    parser.add_argument(
        "--training-graphs",
        nargs="?",
        default="/store/travail/vamaj/Leto/src/funcgnn/dataset/train/",
    ...
    parser.add_argument(
        "--testing-graphs",
        nargs="?",
        default="/store/travail/vamaj/Leto/src/funcgnn/dataset/test/",
    ...
    parser.add_argument(
        "--dropout", type=float, default=0.2, help="Dropout probability. Default is 0.2"
    )
