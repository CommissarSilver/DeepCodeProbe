...
if args.model == "ast_nn":
    ...
    probe_utils.train_probe(
        embedding_func=get_embeddings_infercode,
        collator_fn=collator_fn_infercode,
        train_dataset=train_set,
        valid_dataset=valid_set,
        test_dataset=test_set,
        batch_size=args.batch_size,
    ...
    probe_utils.train_probe(
        embedding_func=get_embeddings_recoder,
        collator_fn=collator_fn_recoder,
        train_dataset=train_set,
        valid_dataset=valid_set,
        test_dataset=test_set,
        batch_size=args.batch_size,
    ...
    model_to_probe = keras.models.load_model("src/dear/models/orig")
    ...
    probe_utils.train_probe(
        embedding_func=get_embeddings_dear,
        collator_fn=collator_fn_dear,
        train_dataset=train_set,
        valid_dataset=valid_set,
        test_dataset=test_set,
        batch_size=args.batch_size,
